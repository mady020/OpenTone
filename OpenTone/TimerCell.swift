...
//            timerRingView.resetRing()
        ...
        // MARK: - Countdown (Non-recursive)
        private func runStartSequence() {
            countdownLabel.isHidden = false
            timerLabel.isHidden = true

            sequenceTimer = Timer.scheduledTimer(withTimeInterval: 0.9, repeats: true) { [weak self] timer in
...
//                    self.timerRingView.animateRing(duration: TimeInterval(self.totalSeconds))
